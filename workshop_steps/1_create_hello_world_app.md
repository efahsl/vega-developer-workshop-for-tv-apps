...
<img src="../images/XHR3a0610450b974a119a77f3f38.jpg" height="400">
...
<img src="../images/XHR81ca84c05fda42c98d2ca42b6.jpg" height="400">
...
<img src="../images/XHR0c9ca828e7c542de9aa3f3ba1.jpg" height="400">
...
If you'd rather use the [Vega Studio VS Code extension](https://developer.amazon.com/docs/vega/0.21/setup-vscode.html) instead of driving through a prompt:

1. In the VS Code Command Palette, run **Vega Project: Create a new Vega project** and follow the interactive wizard.

   <img src="../images/XHR126417328aa245b781134319b.jpg" width="640">

2. Choose the **Hello World** template.

   <img src="../images/XHR7cc1b0243c2545ad92ed89908.jpg" height="400">

3. Choose a directory, project name, and package id when prompted.

   <img src="../images/XHR9f0674b1e1b847d0bfd520dae.jpg" width="640">
...
5. Click the ▶ **Play** icon next to the app in the Vega Studio side bar to build and run.
   ...
   <img src="../images/XHRc12aba94725f4761bd79bb1a7.jpg" height="400">
