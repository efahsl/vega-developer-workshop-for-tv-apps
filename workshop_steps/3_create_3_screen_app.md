...
We want the focus border to always be visible and not be clipped. We will need enough padding/margin between elements to account for the border width. Set an explicit row height so we don't have excess vertical expansion.
