...
You should now see the content row "slide" behind your focused item and it should be MUCH faster especially on-device. Try running your performance tools again for UI fluidity to see a faster set of results.

---

[← Previous: Performance Testing](4_performance_testing.md) | [Next: Next Steps →](6_next_steps.md)
