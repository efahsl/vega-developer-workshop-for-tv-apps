...
> **Note:** For more detailed information about building and testing Vega apps, see [Create a 3 Screen App](optional-followup-exercises/3_create_3_screen_app.md).
